    ...
    <Section id="cta">
      <Container>
        <Panel {...fadeUp}>
          ...
          >
            <li><HiCheckCircle size={16} /> Te respondemos en menos de 24hs</li>
            <li><HiCheckCircle size={16} /> Sin contrato anual</li>
            <li><HiCheckCircle size={16} /> Todo lo que hacemos queda tuyo desde el primer día</li>
          </Trust>
          ...
          >
            ¿Querés construir algo que <span>cambie tu negocio</span>?
          </Headline>
          ...
          >
            Charlemos 30 minutos. Sin compromiso y sin vueltas.
          </Sub>
